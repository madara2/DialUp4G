...
<html lang="en">
    <head>
        <title>Admin | Settings Edit </title>
        <meta charset="utf-8">
                            ...
                            <div class="container-fluid">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><i class="fa fa-pencil"></i> Edit Admin</h3>
                                    </div>
                                    <div class="panel-body">
                                        <form action="" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
                                            <div class="form-group required">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="email" name="adminemail" value="" placeholder="Admin Email" id="input-username" class="form-control" />
                                                </div>
                                            </div>
