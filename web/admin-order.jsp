        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li  class="active"><a href="admin-order.jsp"><i class="fa fa-edit fa-fw">
              ...
              <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="hidden"><a href="#">Orders</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="filter_Order_id" value="" placeholder="Order ID" id="input-order" class="form-control" />
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="filter_emial" value="" placeholder="Email" id="input-email" class="form-control" />
                                                        </div>
                                                    </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right">                    <a href="" class="desc">Order ID</a>
                       <td class="text-right">                    <a href="">Item ID</a>
                    </td>
                    </td>
              ...
              <tbody>
                  ...
                  <td class="text-right">nokia123</td>
                  <td class="text-left">Romaine Fernando</td>
                  <td class="text-left">Pending</td>
                  <td class="text-right">1,505Rs</td>
                  
                  <td class="text-right"><a href="admin-view-order.jsp" data-toggle="tooltip" title="View" class="btn btn-info"><i class="fa fa-eye"></i>
                      
                      </a> <a href="" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                </tr>
