                    ...
                    <div class="centertext">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12 product-viewer clearfix">
                            <div id="product-image-container">
                                ...
                                <img src="image/Microsoft Lumia 532.jpg" </a>		
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12 product">
                            <h1 class="product-name">Nokia</h1>
                            <h2 class="product-name">Lumia 535</h2><br><br><br><br>
                        ...
                        <table cellspacing="0" class="table table-bordered table-striped" style=" width: 802px;">
                            <tbody><tr>
                                ...
                                <tr>
                                    <td class="ttl">4G Network</td>
                                    <td class="nfo">LTE 800 / 900 / 1800 / 2600 (Bands 3, 7, 8, 20)</td>
                                </tr>
                                <tr>
                                    <td class="ttl">SIM</td>
                                ...
                                <tr>
                                    ...
                                    <td class="nfo">Exp. announcement 2015, Q1</td>
                                </tr>
                                <tr>
                                    <td class="ttl">Status</td>
                                    <td class="nfo">release 2015, March</td>
                                </tr>
