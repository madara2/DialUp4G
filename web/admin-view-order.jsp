                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <ul class="nav nav-tabs">
                                            <li class=><a href="#tab-order" data-toggle="tab">Order Details</a></li>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab-order">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <td>Order Status:</td>
                                                        <td id="order-status">Complete</td>
                                                    </tr>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <div class="text-right">
                                                                <button type="button" id="button-customer" data-loading-text="Loading..." class="btn btn-primary"><i class="fa fa-arrow-right"></i> save</button>
